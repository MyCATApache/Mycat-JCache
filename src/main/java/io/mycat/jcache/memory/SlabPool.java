...
//	private boolean mem_limit_reached = false;
//
...
//		if(mem_limit > 0 && memAlloced+len > mem_limit && slabc.perSlab > 0 && globalc.perSlab==0)
//
//			return false;
//		
//		long slab;
...
//		try {
//			SlabClass slabc = slabClassArr[slabsClassid];
//			ret = slabc.do_slabs_alloc(size,slabsClassid,flags);
//		} finally {
